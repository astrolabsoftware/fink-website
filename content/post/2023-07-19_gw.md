...
First, register to get an account on the [livestream service](https://fink-broker.readthedocs.io/en/latest/services/livestream/). Then you can use the [fink-client](https://github.com/astrolabsoftware/fink-client)>=6.0 to get matching alerts in real-time:
